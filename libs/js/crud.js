        ...
        function (transaction, result) {
          if (result.rows.length) {
            $("#listaProductos").append(
              "<tr><th>Código</th><th>Producto</th><th>Precio</th><th>Modificar</th><th>Eliminar</th></tr>"
            );
            for (var i = 0; i < result.rows.length; i++) {
              ...
              $("#listaProductos").append(
                '<tr id="fila' +
                  ...
                  id +
                  '" class="btn btn-dark" onclick="editar()"><img class="iconos" src="libs/img/edit.png" /></button></td><td><button type="button" id="A' +
                  id +
                  '" class="btn btn-dark" onclick="eliminarRegistro()"><img  class="iconos" src="libs/img/delete.png" /></button></td></tr>'
              );
            }
          } else {
            $("#listaProductos").append(
